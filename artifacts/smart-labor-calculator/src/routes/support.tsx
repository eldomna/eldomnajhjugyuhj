...
// الدعم حالياً عبر البريد الإلكتروني فقط (لا أرقام هواتف).
...
export const Route = createFileRoute("/support")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "تواصل مع فريق حاسبة العمال الذكية عبر البريد الإلكتروني للاستفسارات والمساعدة الفنية.",
      },
      { property: "og:title", content: "الدعم الفني | حاسبة العمال الذكية" },
      {
        property: "og:description",
        content: "البريد الإلكتروني للتواصل مع فريق حاسبة العمال الذكية.",
      },
      ...
      <main className="container mx-auto px-4 py-10 md:py-14">
        <header className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-3 text-sm text-muted-foreground md:text-base">
            {ar
              ? "فريقنا جاهز لمساعدتك في أي استفسار حول الحاسبة أو الاشتراكات أو التقارير. راسلنا عبر البريد الإلكتروني."
              : "Our team is ready to help with the calculator, subscriptions, or reports. Reach us by email."}
          </p>
        </header>
